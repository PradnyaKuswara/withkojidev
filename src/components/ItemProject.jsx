            ...
            {datas.map((data) => (
                ...
                >
                    <div className="shadow-lg max-w-xs md:max-w-full mx-auto  rounded-lg  bg-white p-8 my-3">
                        ...
                        <p className="text-xs md:text-sm my-3 text-justify">
                            {data.desc}
                        </p>
                        ...
                        <div className="mt-5 flex flex-col bg-white">
                            <div className="flex overflow-x-scroll pb-10  ">
                                <div className="flex flex-nowrap max-w-xs lg:max-w-lg">
                                    {data.image.map((image) => (
                                        <div
                                            key={image}
                                            className="inline-block px-3 transition ease-in-out delay-100 hover:px-8"
                                        >
                                            <div
                                                className={`${data.image_class}hover:overflow-visible  cursor-pointer max-w-xs overflow-hidden rounded-lg shadow-md bg-white hover:shadow-xl transition duration-300 ease-in-out hover:scale-125 delay-150`}
                                            >
                                                <img
                            ...
                            <div className="mt-5 flex flex-col lg:flow-root ">
                                <a href={data.link_online} rel="noopener">
                                    <span
                                        className={`${data.link_online_class} my-5 p-5 hover:text-teal-900 hover:underline text-lg font-semibold`}
                                    >
                                        <i className="mx-2 fas fa-solid fa-link"></i>
                                        GofitSport
                                    </span>
                                </a>
                                <a href={data.link_github} rel="noopener">
