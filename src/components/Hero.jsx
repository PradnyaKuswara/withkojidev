            ...
            <div className="flex gap-10 justify-center items-center">
                ...
                <div className="animate__animated animate__fadeInRight">
                    ...
                    <h1 className="mb-4 text-lg tiempos font-extrabold tracking-tight  leading-none md:text-3xl">
                        I am{" "}
                        <span className="text-teal-900 text-lg md:text-3xl">
            ...
            <div className="mt-10 grid md:grid-cols-5 gap-16 md:gap-4 max-w-screen-lg mx-auto md:place-content-center md:place-items-center">
                ...
                >
                    <p className="pe-0 lg:pe-6 text-justify  font-light text-gray-500 lg:mb-8 t text-sm lg:text-md">
                        Motivated and enthusiastic Informatics student with a
                        passion for technology. Dedicated to expanding knowledge
                        and skills in various programming languages and software
                        development methodologies. Have basic knowledge of the
                        PHP programming language, Laravel framework, and
                        building application android with Android Studio Kotlin.
                        A quick learner with excellent problem-solving abilities
                    ...
                    <HashLink
                        to="/#project"
                        smooth
                        className="inline-flex items-center justify-center px-7 py-3 mr-3 mt-3 lg:mt-0 transition ease-in-out delay-150 hover:scale-110 duration-300 text-base font-medium text-center text-gray-900  rounded-lg hover:bg-gray-100 focus:ring-4 focus:ring-gray-100"
                    >
                        Project
